...
export default function Login() {
  return (
    <main className="flex-grow pt-24 pb-12 bg-grid-layout relative min-h-screen flex items-center justify-center">
      <div className="absolute inset-0 bg-gradient-to-br from-primary/5 to-transparent pointer-events-none z-0" />
      
      <div className="relative z-10 p-6 bg-white/95 dark:bg-[#07090e]/95 backdrop-blur-xl border border-black/10 dark:border-zinc-800/80 rounded-2xl shadow-[0_0_50px_rgba(0,0,0,0.3)] dark:shadow-[0_0_50px_rgba(0,0,0,0.85)] max-w-md w-full my-8">
        <SignIn 
          signUpUrl="/signup"
          appearance={{
            variables: {
