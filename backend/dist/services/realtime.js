...
exports.broadcastQueryMessage = broadcastQueryMessage;
exports.broadcastQueryStatus = broadcastQueryStatus;
 ...
 */
async function broadcastQueryMessage(queryId, messagePayload) {
    try {
        const channelName = `query:${queryId}`;
        const channel = exports.supabase.channel(channelName);
        ...
        const globalChannel = exports.supabase.channel("queries_feed");
 ...
 */
async function broadcastQueryStatus(queryId, status, additionalData) {
    try {
        const channelName = `query:${queryId}`;
        const channel = exports.supabase.channel(channelName);
        await channel.send({
