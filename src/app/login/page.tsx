...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Administrative credential bypass
    if (
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col justify-start">
      <Navbar />
          ...
          <div className="glass-card p-8 rounded-2xl shadow-2xl border border-black/5 dark:border-white/5 relative overflow-hidden bg-white/20 dark:bg-zinc-950/20">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="space-y-1.5">
                <label className="text-[10px] font-mono text-zinc-500 dark:text-zinc-400 uppercase tracking-widest block">Email or Phone Number</label>
              ...
              <div className="space-y-1.5">
                <div className="flex justify-between items-center">
                  <label className="text-[10px] font-mono text-zinc-500 dark:text-zinc-400 uppercase tracking-widest block">Access Key / Password</label>
                  <Link
                    to="/forgot-password"
            ...
            <div className="mt-6 pt-6 border-t border-black/5 dark:border-white/5 text-center text-xs text-zinc-500 font-medium">
              New client or engineer?{" "}
              <Link to="/signup" className="text-primary dark:text-[#00d1ff] hover:underline font-bold">
                Join RecodeX
              </Link>
            </div>
